...
void skills() {
  ...
  chassis.wait_drive();
  intake = 10;
  chassis.set_swing_pid(ez::
  LEFT_SWING, 0, SWING_SPEED);
  chassis.wait_drive();
  leftWing.set_value(1);
  rightWing.set_value(1);
  pros::delay(500);
  chassis.set_drive_pid(26, 125);
  chassis.wait_drive();
  pros::delay(250);
  chassis.set_drive_pid(-26, 70);
  chassis.wait_drive();
  ...
  chassis.wait_drive();
  intake = 20;
  chassis.set_swing_pid(ez::LEFT_SWING, 90, 50);
  chassis.wait_drive();
  intake = 10;
